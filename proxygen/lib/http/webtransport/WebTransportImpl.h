...
class WebTransportImpl : public WebTransport {
 public:
  class TransportProvider {
   public:
    ...
    sendWebTransportStreamData(HTTPCodec::StreamID /*id*/,
                               ...
                               bool /*eof*/,
                               quic::QuicSocket::WriteCallback* /*wcb*/) = 0;
    ...
    initiateReadOnBidiStream(
        ...
        quic::QuicSocket::ReadCallback* /*readCallback*/) = 0;
  ...
  class StreamReadHandle
   ...
   public:
    ...
    TransportProvider::FCState dataAvailable(std::unique_ptr<folly::IOBuf> data,
                                             bool eof);
 ...
 private:
  folly::Expected<TransportProvider::FCState, WebTransport::ErrorCode>
  sendWebTransportStreamData(HTTPCodec::StreamID id,
                             std::unique_ptr<folly::IOBuf> data,
                             bool eof,
